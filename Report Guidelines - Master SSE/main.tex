...
\noindent Falls among elderly individuals are a major cause of injury, hospitalization, and death, posing a serious burden on healthcare systems worldwide\cite{who}. Wearable sensors, particularly smartwatches, are emerging as an effective platform for continuous fall detection due to their accessibility, portability, and integration with smartphones[2]. Smartwatches typically incorporate Inertial Measurement Units (IMUs) that include accelerometers and gyroscopes capable of capturing fine-grained motion data in real time[3].
...
{\tt https://www.who.int/news-room/fact-sheets/detail/falls}

\bibitem{2}
Patel, S., Park, H., Bonato, P., Chan, L., \& Rodgers, M. (2012). 
{\it A review of wearable sensors and systems with application in rehabilitation},
Journal of NeuroEngineering and Rehabilitation. 
{\tt https://doi.org/10.1186/1743-0003-9-21}
